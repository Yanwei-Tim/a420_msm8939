...
include art2/build/Android.common_build.mk
...
$$(ENUM_OPERATOR_OUT_GEN): $$(GENERATED_SRC_DIR)/%_operator_out.cc : $(LOCAL_PATH)/%.h
  ...
  LOCAL_C_INCLUDES += $(ART_C_INCLUDES) art2/runtime

  ifeq ($$(art_target_or_host),host)
    # For compiler driver TLS.
    LOCAL_LDLIBS += -lpthread
  endif
  LOCAL_ADDITIONAL_DEPENDENCIES := art2/build/Android.common_build.mk
