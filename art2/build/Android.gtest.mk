...
include art2/build/Android.common_test.mk
include art2/build/Android.common_path.mk
...
LOCAL_C_INCLUDES := $(ART_C_INCLUDES) art2/runtime art/compiler
...
define define-art-gtest
  ...
  LOCAL_C_INCLUDES += $$(ART_C_INCLUDES) art2/runtime $$(art_gtest_extra_c_includes)
