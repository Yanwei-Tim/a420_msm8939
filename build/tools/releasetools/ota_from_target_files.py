...
#wangqing.yu change from fota, default = false
...
#add by adela for update splash
def CopyFirmwareFiles(input_zip, output_zip,script):
   splash_img = common.GetBootableImage("splash.img", "splash.img",
                                     OPTIONS.input_tmp, "SPLASH")
   common.CheckSize(splash_img.data, "splash.img", OPTIONS.info_dict)
   common.ZipWriteStr(output_zip, "splash.img", splash_img.data)
   script.WriteRawImage("/splash", "splash.img")
#end add by adela
...
#add by adela for update slash
  CopyFirmwareFiles(input_zip, output_zip,script)
#end add by adelax
