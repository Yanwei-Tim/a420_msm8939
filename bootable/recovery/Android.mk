...
LOCAL_STATIC_LIBRARIES += libfotaupdate_64
else
...
ifeq ($(strip $(FOTA_UPDATE_SUPPORT)), true)
include $(CLEAR_VARS)
LOCAL_MODULE        := libfotaupdate
LOCAL_MODULE_CLASS  := STATIC_LIBRARIES
LOCAL_MODULE_SUFFIX := .a
LOCAL_SRC_FILES	    := libfotaupdate.a
LOCAL_MULTILIB      := 32
include $(BUILD_PREBUILT)
endif
ifeq ($(strip $(FOTA_UPDATE_SUPPORT)), true)
include $(CLEAR_VARS)
LOCAL_MODULE        := libfotaupdate_64
LOCAL_MODULE_CLASS  := STATIC_LIBRARIES
LOCAL_MODULE_SUFFIX := .a
LOCAL_SRC_FILES	    := libfotaupdate_64.a
LOCAL_MULTILIB      := 64
include $(BUILD_PREBUILT)
endif
#fota end
