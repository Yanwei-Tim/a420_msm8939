DEVICE_PACKAGE_OVERLAYS := device/qcom/msm8939_64_s700/overlay
...
# splash img
PRODUCT_COPY_FILES += \
    device/qcom/msm8939_64_s700/splash.img:splash.img

# wangqing.yu add for 12 pin
PRODUCT_COPY_FILES += \
    device/qcom/msm8939_64_s700/chmod_dev.sh:system/etc/chmod_dev.sh
...
PRODUCT_NAME := msm8939_64_s700
PRODUCT_DEVICE := msm8939_64_s700
...
PRODUCT_COPY_FILES += \
    ...
    device/qcom/msm8939_64_s700/mixer_paths_skuk.xml:system/etc/mixer_paths_skuk.xml \
    ...
    device/qcom/msm8939_64_s700/aanc_tuning_mixer.txt:system/etc/aanc_tuning_mixer.txt
...
PRODUCT_COPY_FILES += \
    device/qcom/msm8939_64_s700/msm_irqbalance.conf:system/vendor/etc/msm_irqbalance.conf

# MSM Thermal  Balancer configuration file
#PRODUCT_COPY_FILES += \
#    device/qcom/msm8939_64_s700/thermal-engine.conf:system/etc/thermal-engine.conf

#wlan driver
PRODUCT_COPY_FILES += \
    device/qcom/msm8939_64_s700/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    device/qcom/msm8939_64_s700/WCNSS_wlan_dictionary.dat:persist/WCNSS_wlan_dictionary.dat \
    device/qcom/msm8939_64_s700/WCNSS_qcom_wlan_nv.bin:persist/WCNSS_qcom_wlan_nv.bin
