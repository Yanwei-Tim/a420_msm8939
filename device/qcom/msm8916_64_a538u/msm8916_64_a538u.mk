DEVICE_PACKAGE_OVERLAYS := device/qcom/msm8916_64_a538u/overlay
...
# splash img
PRODUCT_COPY_FILES += \
    device/qcom/msm8916_64_a538u/splash.img:splash.img

#add widevine by zj. start
...
PRODUCT_PROPERTY_OVERRIDES += \
ro.com.google.clientidbase=android-trimble
#add by zj for GMS

PRODUCT_NAME := msm8916_64_a538u
PRODUCT_DEVICE := msm8916_64_a538u
...
PRODUCT_COPY_FILES += \
    ...
    device/qcom/msm8916_64_a538u/mixer_paths_qrd_skui.xml:system/etc/mixer_paths_qrd_skui.xml \
    ...
    device/qcom/msm8916_64_a538u/mixer_paths_skuk.xml:system/etc/mixer_paths_skuk.xml \
    ...
    device/qcom/msm8916_64_a538u/aanc_tuning_mixer.txt:system/etc/aanc_tuning_mixer.txt
...
PRODUCT_COPY_FILES += \
    device/qcom/msm8916_64_a538u/msm_irqbalance.conf:system/vendor/etc/msm_irqbalance.conf

# MSM Thermal  Balancer configuration file
#PRODUCT_COPY_FILES += \
#    device/qcom/msm8916_64_a538u/thermal-engine.conf:system/etc/thermal-engine.conf

#wlan driver
PRODUCT_COPY_FILES += \
    device/qcom/msm8916_64_a538u/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
    device/qcom/msm8916_64_a538u/WCNSS_wlan_dictionary.dat:persist/WCNSS_wlan_dictionary.dat \
    device/qcom/msm8916_64_a538u/WCNSS_qcom_wlan_nv.bin:persist/WCNSS_qcom_wlan_nv.bin
...
PRODUCT_COPY_FILES += \
					  device/qcom/common/nfc/Firmware/libpn547_fw_08_01_26_prod_plm_64bits.so:system/vendor/firmware/libpn547_fw.so \
					  ...
					  device/qcom/common/nfc/etc/libnfc-nxp.conf:system/etc/libnfc-nxp.conf \
					  device/qcom/common/nfc/etc/libnfc-brcm.conf:system/etc/libnfc-brcm.conf
#############   NFC  PN547 #############################
...
PRODUCT_LOCALES := en_US en_GB zh_CN zh_HK fr_FR de_DE it_IT ko_KR ja_JP pt_PT pt_BR ru_RU es_ES el_GR nl_BE bg_BG cs_CZ da_DK fi_FI hu_HU lt_LT es_UY pl_PL ro_RO sr_SP sv_SE tr_TR
