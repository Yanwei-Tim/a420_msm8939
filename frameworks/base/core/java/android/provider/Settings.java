...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
        public static final int END_BUTTON_BEHAVIOR_DEFAULT = SystemProperties.get("ro.config.doublescreen","0").equals("1") ? END_BUTTON_BEHAVIOR_HOME : END_BUTTON_BEHAVIOR_SLEEP;
	...
	public static final String LOCATION_UPDATE_RATE = "location_update_rate";
	//add location rate by zzj end
	
	public static final String ANALOG_ENABLE = "analog_enable";
        public static final String ANALOG_STYLE = "analog_style";
        public static final String ANALOG_SOUNDS_ENABLE ="analog_sounds_enable";
	public static final String  FOLDER_OPEN_ANSWER_CONTROLLOR = "folder_open_answer_controllor";
        public static final String  FOLDER_CLOSE_DROP_CONTROLLOR = "close_folder_drop_controllor";
        public static final String  FOLDER_CLOSE_CAN_ANSWER_CONTROLLOR = "close_folder_can_answer_controllor";
