...
public class KeyEvent extends InputEvent implements Parcelable {
	...
	private static boolean mIsDoubleScreen = SystemProperties.get("ro.config.doublescreen","0").equals("1");
   ...
   //add keys by zzj start
    public static final int KEYCODE_USB_OTG = 276;
    public static final int KEYCODE_HALL_OPEN = 277;
    public static final int KEYCODE_HALL_CLOSE = 278;
    public static final int KEYCODE_DISPLAY_OFF = 279;
    public static final int KEYCODE_RECENT = 280;
    public static final int KEYCODE_SWITCH_SIM = 281;
    public static final int KEYCODE_FOLDER_OPEN = 282;
    public static final int KEYCODE_FOLDER_CLOSE = 283;

    //start add KEY EXT_ANT_TOUCH
        public static final int KEYCODE_EXT_ANT_TOUCH = 284;
        public static final int KEYCODE_EXT_ANT_RELEASE = 285;
        private static final int LAST_KEYCODE = KEYCODE_EXT_ANT_RELEASE;
    //end 
   ...
   //add keys by zzj end
    ...
    public static final boolean isWakeKey(int keyCode) {
        switch (keyCode) {
	//fix bug 13724 by zzj start
           // case KeyEvent.KEYCODE_BACK:
           // case KeyEvent.KEYCODE_MENU:
           // case KeyEvent.KEYCODE_HOME:
	//fix bug 13724 by zzj end
            ...
            case KeyEvent.KEYCODE_EXT_ANT_TOUCH:
            case KeyEvent.KEYCODE_EXT_ANT_RELEASE:
                return true;
	...
	private static final boolean isFolderOpen(){
		return SystemProperties.get("persist.sys.folderopen","0").equals("1");
	}
