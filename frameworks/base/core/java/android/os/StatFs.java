...
import com.lovdream.util.DeceptionUtil;
...
public class StatFs {
    ...
    public StatFs(String path) {
        mStat = doStat(path);
        /*add by yangzhiming 20170215 for bug 0013991 start*/
        if(DeceptionUtil.isShouldDeception()){
            long f_bsize = mStat.f_bsize * 5;
            mStat = new StructStatVfs(f_bsize, mStat.f_frsize, mStat.f_blocks, mStat.f_bfree,
                mStat.f_bavail, mStat.f_files, mStat.f_ffree, mStat.f_favail, mStat.f_fsid, mStat.f_flag, mStat.f_namemax);
        }
        /*add by yangzhiming 20170215 for bug 0013991 end*/
    }
