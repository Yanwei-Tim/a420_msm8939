...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
	...
	public static void showAudioMessage(Context context,boolean isSilent){
		Toast.makeText(context,isSilent ? R.string.switch_ringer_normal : R.string.switch_ringer_vibrate,Toast.LENGTH_SHORT).show();
	}
    ...
    private void prepareDialog() {
    	...
    	Log.i(TAG, "prepareDialog");
        refreshSilentMode();
        
        //start fix bug of 13714
        ...
        Log.i(TAG, "mAirplaneState = " + mAirplaneState);
    ...
    private static abstract class ToggleAction implements Action {
        ...
        public final void onPress() {
         ...
         //end 
        	...
        	Log.i(TAG,"======onPress======" + mState);
        	
            final boolean nowOn = !(mState == State.On || mState == State.TurningOn);
        ...
        public boolean isEnabled() {
            return true /* !mState.inTransition() */; //fix bug of 13714
        }
    ...
    private void onAirplaneModeChanged() {
    	 ...
    	 Log.i(TAG, "onAirplaneModeChanged=============");
    	
        // Let the service state callbacks handle the state.
    	//start  fix bug of 13714 add by chr 
       // if (mHasTelephony) return;
    	 //end 
    ...
    private void changeAirplaneModeSystemSetting(boolean on) {
    	...
    	Log.i(TAG,"changeAirplaneModeSystemSetting on = " + on);
