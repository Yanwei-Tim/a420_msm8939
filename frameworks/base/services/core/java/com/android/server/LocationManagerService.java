...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    public void requestLocationUpdates(LocationRequest request, ILocationListener listener,
        ...
        if(!allowAccessApp(packageName)) //allow camera access to Location.by zj.
     ...
     * allow camera access to Location.by zj.
     */
    private boolean allowAccessApp(String packageName) {
    	String app = "org.codeaurora.snapcam";
    	boolean flag = true;
