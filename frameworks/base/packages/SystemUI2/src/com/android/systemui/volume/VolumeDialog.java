...
public class VolumeDialog {
    ...
    public VolumeDialog(Context context, int windowType, VolumeDialogController controller,
        ...
        //start change drawable for bug 14321 
        addRow(AudioManager.STREAM_RING,
                R.drawable.vol_ringer, R.drawable.vol_ringer, true);
        addRow(AudioManager.STREAM_MUSIC,
                R.drawable.vol_ringer, R.drawable.vol_vibrate, true);
        addRow(AudioManager.STREAM_ALARM,
                R.drawable.vol_ringer, R.drawable.vol_vibrate, false);
    ...
    private void updateWindowWidthH() {
        ...
        final int max = mContext.getResources()
                .getDimensionPixelSize(R.dimen.standard_notifipel_width_dialog);
        if (w > max) {
            w = max;
        }
    ...
    private VolumeRow initRow(final int stream, int iconRes, int iconMuteRes, boolean important) {
        ...
        row.slider.setProgressTintList(mActiveSliderTint);
        row.slider.setThumbTintList(mActiveSliderTint);
    ...
    private void onStateChangedH(State state) {
        ...
        for (int i = 0; i < state.states.size(); i++) {
            ...
            if (findRow(stream) == null) {
            	//change drawable for bug 14321
                addRow(stream, R.drawable.vol_ringer, R.drawable.vol_vibrate, true);
            }
        }
    ...
    private void updateFooterH() {
        ...
        Util.setVisOrGone(mZenFooter, false /* visible */); //set footer invisible for bug 14321
        mZenFooter.update();
    }
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        //start change vibrate icon 
        final int iconRes =
                isRingVibrate ? R.drawable.vol_vibrate
        ...
        row.iconState =
                iconRes == R.drawable.vol_vibrate ? Events.ICON_STATE_VIBRATE
