...
public class SearchTile extends QSTile<QSTile.BooleanState> {
...
//    private boolean mListening;
	...
	private Intent searchintent = new Intent().setComponent(new ComponentName(
            "com.android.quicksearchbox", "com.android.quicksearchbox.SearchActivity"));

    public SearchTile(Host host) {
        super(host);
...
//        mDisable.setAllowAnimation(true);
       mHost.startActivityDismissingKeyguard(searchintent);
    }
...
//        final boolean airplaneMode = value != 0;
        state.value = true;
        state.visible = true;
        state.label = mContext.getString(R.string.qs_search);  
        state.icon = ResourceIcon.get(R.drawable.search1);
    }
