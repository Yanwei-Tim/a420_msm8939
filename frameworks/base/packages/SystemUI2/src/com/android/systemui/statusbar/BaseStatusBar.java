...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    protected boolean shouldInterrupt(Entry entry, StatusBarNotification sbn) {
        ...
        boolean isFromDialer = sbn.getPackageName().equals("com.android.dialer");//add by yangzhiming 20161227 for bug 0014091
        ...
        boolean interrupt = (isFullscreen || (isHighPriority && (isNoisy || hasTicker)))
                ...
                && !mStatusBarKeyguardViewManager.isInputRestricted() && !isFromDialer;//modify by yangzhiming 20161227 for bug 0014091
        try {
