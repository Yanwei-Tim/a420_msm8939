...
public class BrightnessController implements ToggleSlider.Listener {
    ...
    private final CheckBox  mAutobox;
    ...
    private final String FOLDER_OPEN = "com.android.lockscreen.folderopen";
    private final String FOLDER_CLOSE = "com.android.lockscreen.folderclose";
    private int flag_folder = -1;
    ...
    private BroadcastReceiver folderopen = new BroadcastReceiver()
    {
		@Override
		public void onReceive(Context context, Intent intent) {
			...
			if(actionString.equals(FOLDER_OPEN))	
			{
				flag_folder = -1;
			...
			else if(actionString.equals(FOLDER_CLOSE))
			{
				flag_folder = 1;
				if(mAutobox != null)
				{
					mAutobox.setVisibility(View.GONE);
				}
...
//    }
    ...
    public BrightnessController(Context context, ImageView icon, ToggleSlider control, CheckBox box) {
        mContext = context;
        mIcon = icon;
        mControl = control;
        ...
        if(flag_folder == 1 || SystemProperties.getInt("persist.sys.folderopen", 1)==0)
		{
        	mAutobox.setVisibility(View.GONE);
		}else {
			mAutobox.setVisibility(View.VISIBLE);
        ...
        mAutobox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				if(flag_folder == 1 || SystemProperties.getInt("persist.sys.folderopen", 1)==0)
				{
					...
					//Toast.makeText(mContext, mContext.getResources().getString(R.string.cantopenlg), Toast.LENGTH_SHORT).show();
					return;
				}
        ...
        //start fix bug of 11422 add by chr
        RigisterFolder();
        //end 
    ...
    public BrightnessController(Context context, ImageView icon, ToggleSlider control, CheckBox box, TextView lable) {
        mContext = context;
        mIcon = icon;
        mControl = control;
        lableTextView = lable;
    ...
    private void RigisterFolder()
    {
    	IntentFilter intentFilter  = new IntentFilter();
    	
    	intentFilter.addAction(FOLDER_OPEN);
    	intentFilter.addAction(FOLDER_CLOSE);
    	
    	mContext.registerReceiver(folderopen, intentFilter);
