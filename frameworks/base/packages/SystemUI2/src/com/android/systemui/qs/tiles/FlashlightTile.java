...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    private Icon enable = null;
    
    private Icon disenable = null;
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
      ...
      //  icon.setAllowAnimation(arg instanceof UserBoolean && ((UserBoolean) arg).userInitiated);
        if(enable == null)
        {
        	enable =  ResourceIcon.get(R.drawable.ic_signal_flashlight_enablelg);
        }
        if(disenable == null)
        {
        	disenable =  ResourceIcon.get(R.drawable.ic_signal_flashlight_disablelg);
        }
        
        state.icon = state.value ? enable : disenable;
