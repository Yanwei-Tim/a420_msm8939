...
public class KeyguardViewMediator extends SystemUI {
    ...
    private final String openaction =  "com.android.lockscreen.folderopen";
    
    private final String closeaction  = "com.android.lockscreen.folderclose";
    ...
    ViewMediatorCallback mViewMediatorCallback = new ViewMediatorCallback() {
        ...
        public void readyForKeyguardDone() {
            if (mKeyguardDonePending) {
            	...
            	Log.i(TAG, "=================readyForKeyguardDone=======================");
                KeyguardViewMediator.this.keyguardDone(true /* authenticated */);
            }
        }
    ...
    private void setupLocked() {
        ...
        mContext.registerReceiver(mBroadcastReceiver, intentFilter /* new IntentFilter(DELAYED_KEYGUARD_ACTION) */);
    ...
    private void doKeyguardLocked(Bundle options) {
    	 ...
    	 int flag_folder = SystemProperties.getInt("persist.sys.folderopen", 1);
    	
    	if(flag_folder == 1 && !isSecure())
    	{
    ...
    private void showLocked(Bundle options) {
        ...
        {
        	mPhoneStatusBar.setkeyguardbackground(1);
        }
    }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if( closeaction.equals(intent.getAction())){
			    
                doKeyguardLocked(null);     
                if(DEBUG)
                	Log.i(TAG, "=========doKeyguardLocked==========");
            }
    ...
    private void handleHide() {
        synchronized (KeyguardViewMediator.this) {
            ...
            if (mShowing && !mOccluded) {
                ...
                if(mPhoneStatusBar != null)
                {
                	Log.i(TAG, "==============mPhoneStatusBar.setkeyguardbackground(-1);===============");
                	mPhoneStatusBar.setkeyguardbackground(-1);
                }
