...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private Handler mHandlerbg = new Handler(){
    	...
    	public void handleMessage(Message msg) {
    		...
    		if(msg.what == 0x11)
    		{
    	    	...
    	    	{
    	    		Log.i(TAG, "==========mNotificationPanel.setBackgroundColor(color.backgroud)=========");
    	    		mNotificationPanel.setBackgroundResource(R.drawable.lock_screen);
    	    	}
    		}
    		else if(msg.what == 0x12)
    		{
    			if(mNotificationPanel != null)
    	    	{
    	    		mNotificationPanel.setBackgroundColor(color.transparent);	
    	    	}
    		}
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mKeyguardIndicationController = new KeyguardIndicationController(mContext,
                ...
                mKeyguardBottomArea.getLockIcon(),(TextView)mStatusBarWindow.findViewById(
                        R.id.keyguard_unlock_text)); //fix bug of 14348
        ...
        mNfcController  = new NfcController(mContext);
...
//        }
        ...
        if (mQSPanel != null) {
         ...
         //   mQSPanel.setTiles_display(qsh.getTiles());
    ...
    private void startKeyguard() {
        ...
        keyguardViewMediator.setPhoneStatusBar(this);
    }

    public void setkeyguardbackground(int backgroud)
    {
    	if(backgroud == -1)
    	{
    		mHandlerbg.sendEmptyMessage(0x12);
    	}else{
    		mHandlerbg.sendEmptyMessage(0x11);
    	}
    ...
    protected void updateCarrierLabelVisibility() {
        ...
        boolean makeVisible = mStackScroller.getVisibility() == View.VISIBLE
                && mState != StatusBarState.KEYGUARD;
        ...
        if ((mCarrierLabel.getVisibility() == View.VISIBLE) != makeVisible) {
            ...
            Log.i(TAG, "==============mCarrierLabel.setVisibility=====================");
          
            if(!mNotificationPanel.isqsPanelshown())
            {
            	makeVisible = false;
            }
    ...
    public boolean onBackPressed() {
     ...
     //   Log.i("test123", "===================onBackPressed============" + mNotificationPanel.isQsExpanded());
...
//            return true;
    ...
    public void onUnlockHintStarted() {
    	//start remove follow code for bug 14348
