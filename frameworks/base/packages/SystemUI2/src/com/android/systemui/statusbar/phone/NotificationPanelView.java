...
public class NotificationPanelView extends PanelView implements
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //start add by chr
        mQsMinExpansionHeight = mKeyguardShowing ? 0 :mHeader.getExpandedHeight() + mQsContainer.getDesiredHeight() ;
...
//        }//end 
    ...
    private void setQsExpansion(float height) {
        ...
        Log.i("test", "mQsFullyExpanded = " + mQsFullyExpanded);
        //start 
        if(!mKeyguardShowing)
        {
    ...
    protected void onHeightUpdated(float expandedHeight) {
    	//start  fix bug of 14351
    	Log.i(TAG, "============onHeightUpdated==============" + mQsPanel.isShown());
