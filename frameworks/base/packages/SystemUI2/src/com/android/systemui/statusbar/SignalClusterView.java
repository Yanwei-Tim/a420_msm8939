...
public class SignalClusterView
    ...
    View mNoSimsCombo ,mNoSimsCombo2;
    ImageView mVpn, mEthernet, mWifi, mAirplane,
                mNoSims,mNoSims2, mEthernetDark, mWifiDark, mNoSimsDark,mNoSimsDark2, mImsOverWifiImageView;
    ...
    protected void onAttachedToWindow() {
        ...
        mNoSims2        = (ImageView) findViewById(R.id.no_sims2);
        mNoSimsDark     = (ImageView) findViewById(R.id.no_sims_dark);
        mNoSimsDark2    = (ImageView) findViewById(R.id.no_sims_dark2);
        mImsOverWifiImageView    = (ImageView) findViewById(R.id.ims_over_wifi);
        mNoSimsCombo    =             findViewById(R.id.no_sims_combo);
        mNoSimsCombo2   = 			  findViewById(R.id.no_sims_combo2);
    ...
    private void apply() {
        ...
        //start fix bug of 14309 add by chr
        boolean isno1 = TelephonyManager.getDefault().hasIccCard(0);
        ...
        boolean isno2 = TelephonyManager.getDefault().hasIccCard(1);
        
        Log.i(TAG, isno1 + "========= "+ isno2 + "===================");
        //end 
       ...
       //start fix bug of 14309 add by chr 
        if(!isno2)
        {
        	mNoSimsCombo2.setVisibility(View.VISIBLE);
        }else {
        	mNoSimsCombo2.setVisibility(View.GONE);
		}
        //end 
