...
public class WifiTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleLongClick() {
    	...
    	WIFI_SETTINGS.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    	lgstartActivity(WIFI_SETTINGS);
    }
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if (!state.enabled) {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_wifi_disabledlg);
            ...
            state.icon = ResourceIcon.get(R.drawable.ic_qs_wifi_full_lg_4);
            state.label = r.getString(R.string.quick_settings_wifi_label);
