...
public class QSTileView extends ViewGroup {
    ...
    protected View createIcon() {
        ...
        icon.setBackgroundResource(R.drawable.qstitlebg_lg);
        return icon;
    }

    private Drawable newTileBackground() {
        final int[] attrs = new int[] {android.R.attr.selectableItemBackground /* android.R.attr.selectableItemBackgroundBorderless */};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mIcon.measure(iconSpec /*MeasureSpec.makeMeasureSpec(w, MeasureSpec.AT_MOST) */, iconSpec);
