...
public class RedassisTile extends QSTile<QSTile.BooleanState> {
...
//        mgr.setAirplaneMode(enabled);
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.value = true;
        state.visible = true;
        state.label = mContext.getString(R.string.qs_redassis);  
        state.icon = ResourceIcon.get(R.drawable.redassis1);
    }
