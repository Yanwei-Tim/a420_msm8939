...
public class RecentsActivity extends Activity implements RecentsView.RecentsViewCallbacks,
    ...
    private Button recents_clearbn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recents_clearbn = (Button)findViewById(R.id.recents_clear);
        recents_clearbn.setOnClickListener(new View.OnClickListener() {
    ...
    private void revomeAllTasks()
    {
    	if(mRecentsView != null)
    	{
    	//	mRecentsView.dissmissAllTasks();
