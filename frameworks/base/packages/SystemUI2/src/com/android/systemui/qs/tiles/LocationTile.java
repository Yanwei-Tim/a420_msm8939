...
//        mDisable.setAllowAnimation(true);
    ...
    protected void handleLongClick() {
    	...
    	Log.i("test", "=================handleLongClick===================");
    	Scrrenshot(KeyEvent.KEYCODE_BACK);
    	LOCATION_SETTINGS.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    	lgstartActivity(LOCATION_SETTINGS);
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (locationEnabled) {
            state.icon =  ResourceIcon.get(R.drawable.ic_signal_location_ablelg) ;// mEnable;
            state.label = mContext.getString(R.string.quick_settings_location_label);
            state.contentDescription = mContext.getString(
                    R.string.accessibility_quick_settings_location_on);
        } else {
            state.icon = ResourceIcon.get(R.drawable.ic_signal_location_disablelg) ;
            state.label = mContext.getString(R.string.quick_settings_location_label);
            state.contentDescription = mContext.getString(
