...
class DatabaseHelper extends SQLiteOpenHelper {
	...
	//add location rate by zzj start
	    loadIntegerSetting(stmt, Settings.System.LOCATION_UPDATE_RATE,
                    R.integer.def_location_update_rate);
	//add location rate by zzj end

	 //set def analog state by zzj start
            loadIntegerSetting(stmt, Settings.System.ANALOG_ENABLE,
                    R.integer.def_analog_enabled);
            loadIntegerSetting(stmt,Settings.System.ANALOG_SOUNDS_ENABLE,
                    R.integer.def_analog_sounds_enabled);
            //set def analog state by zzj end

	 // set def answer controll by zzj start
           loadIntegerSetting(stmt, Settings.System.FOLDER_OPEN_ANSWER_CONTROLLOR,
                    R.integer.def_open_folder_to_answer);
           loadIntegerSetting(stmt, Settings.System.FOLDER_CLOSE_DROP_CONTROLLOR,
                    R.integer.def_close_folder_to_drop);
           loadIntegerSetting(stmt, Settings.System.FOLDER_CLOSE_CAN_ANSWER_CONTROLLOR,
                    R.integer.def_out_screen_can_answer);
           // set def answer controll by zzj en
