...
public class CarrierText extends TextView {
    ...
    private boolean a420 = android.os.SystemProperties.get("ro.product.name").equals("msm8916_64_a420");
    ...
    protected void updateCarrierText() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if(a420){
                if(!isno1) {
                    displayText =  getContext().getText(R.string.nosimcardlg) +"     " + displayText;
                }
                if(!isno2){
                      displayText = displayText +"     " +  getContext().getText(R.string.nosimcardlg)  ;
                }
            }
            //end 
        }
