...
enum {
   ...
   //add keys by zzj start
    AKEYCODE_USB_OTG           = 276,
    AKEYCODE_HALL_OPEN           = 277,
    AKEYCODE_HALL_CLOSE           = 278,
   //add keys by zzj end
    AKEYCODE_DISPLAY_OFF		=279,
    AKEYCODE_RECENT            = 280,
    AKEYCODE_SWITCH_SIM           = 281,
    AKEYCODE_FOLDER_OPEN	=282,
    AKEYCODE_FOLDER_CLOSE	=283,
    AKEYCODE_EXT_ANT_TOUCH = 284,
    AKEYCODE_EXT_ANT_RELEASE = 285
