...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(HALL_OPEN),
    DEFINE_KEYCODE(HALL_CLOSE),
    DEFINE_KEYCODE(DISPLAY_OFF),
    DEFINE_KEYCODE(RECENT),
    DEFINE_KEYCODE(SWITCH_SIM),
    DEFINE_KEYCODE(FOLDER_OPEN),
    DEFINE_KEYCODE(FOLDER_CLOSE),
    DEFINE_KEYCODE(EXT_ANT_TOUCH),
    DEFINE_KEYCODE(EXT_ANT_RELEASE),
    { NULL, 0 }
};
